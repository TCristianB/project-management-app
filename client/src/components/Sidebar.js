		...
		<>
			<div className={`sidebar ${menuButton.sideBar ? '' : 'open'}`}>
				<i
					...
					className={`fas fa-bars bars-icon ${menuButton.iconOpen ? '' : 'icon-open'}`}
				></i>
